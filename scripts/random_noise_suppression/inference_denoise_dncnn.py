...
Example (single GPU):
    python scripts/random_noise_suppression/inference_denoise_dncnn.py \
        --config configs/random_noise_suppression/denoise_dncnn.yaml \
        --checkpoint results/random_noise_dncnn_base/checkpoints/epoch_0049.pt \
        --output-dir results/random_noise_dncnn_base/inference \
        --noise-kind gaussian \
        --snr-db 5 \
        --n-viz-shots 5
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs/random_noise_suppression/denoise_dncnn.yaml",
