...
Example (single GPU):
    python scripts/random_noise_suppression/inference_denoise_res_unet.py \
        --config configs/random_noise_suppression/denoise_res_unet.yaml \
        --checkpoint results/random_noise_res_unet_base/checkpoints/epoch_0049.pt \
        --output-dir results/random_noise_res_unet_base/inference \
        --noise-kind gaussian \
        --snr-db 5 \
        --n-viz-shots 5
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs/random_noise_suppression/denoise_res_unet.yaml",
