"""ResUNet multiples attenuation inference: noisy SEG-Y → denoised SEG-Y.

Example::

    python scripts/multiples_attenuation/inference/inference_denoise_res_unet.py \\
...
_DEFAULT_CONFIG = "configs/multiples_attenuation/denoise_res_unet.yaml"
...
def main() -> None:
    p = argparse.ArgumentParser(description="ResUNet multiples attenuation inference.")
