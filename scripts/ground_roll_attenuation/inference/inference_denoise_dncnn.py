"""DnCNN ground-roll attenuation inference: noisy SEG-Y → denoised SEG-Y.

Example::

    python scripts/ground_roll_attenuation/inference/inference_denoise_dncnn.py \\
        --config configs/ground_roll_attenuation/denoise_dncnn.yaml \\
...
_DEFAULT_CONFIG = "configs/ground_roll_attenuation/denoise_dncnn.yaml"
...
def main() -> None:
    p = argparse.ArgumentParser(description="DnCNN ground-roll attenuation inference.")
