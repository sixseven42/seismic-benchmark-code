...
BASE_CONFIG="${REPO_ROOT}/configs/ground_roll_attenuation/field/denoise_dncnn.yaml"
PY_SCRIPT="${REPO_ROOT}/scripts/ground_roll_attenuation/train/train_denoise_dncnn.py"
