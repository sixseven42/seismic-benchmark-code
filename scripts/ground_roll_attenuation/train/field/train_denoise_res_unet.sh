...
BASE_CONFIG="${REPO_ROOT}/configs/ground_roll_attenuation/field/denoise_res_unet.yaml"
PY_SCRIPT="${REPO_ROOT}/scripts/ground_roll_attenuation/train/train_denoise_res_unet.py"
