...
BASE_CONFIG="${REPO_ROOT}/configs/ground_roll_attenuation/field/denoise_dfb_cnn.yaml"
PY_SCRIPT="${REPO_ROOT}/scripts/ground_roll_attenuation/train/train_denoise_dfb_cnn.py"
