...
CUDA_VISIBLE_DEVICES=6,7 torchrun --nproc_per_node=2 \\
    scripts/ground_roll_attenuation/train/train_denoise_sanet.py \\
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=str, default="configs/ground_roll_attenuation/denoise_sanet.yaml")
