...
BASE_CONFIG="${REPO_ROOT}/configs/ground_roll_attenuation/denoise_physics.yaml"
PY_SCRIPT="${REPO_ROOT}/scripts/ground_roll_attenuation/train_denoise_physics.py"
